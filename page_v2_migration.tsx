        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col items-center justify-center gap-6">
            ...
            <div className="flex items-center gap-8 text-xs font-bold text-slate-500 uppercase tracking-widest">
              <span>369 Repositories</span>
              <span className="w-1 h-1 bg-slate-800 rounded-full" />
              <span>200,000 Downloads</span>
              <span className="w-1 h-1 bg-slate-800 rounded-full" />
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <p className="text-slate-400 text-lg mb-8 leading-relaxed">
                Monetizing 290+ open-source assets into production-ready governance bundles. Secure your agents with curated server packs for Finance, Healthcare, and the EU AI Act.
              </p>
